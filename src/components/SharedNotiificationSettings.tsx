...
const SharedNotiificationSettings = ({
  ...
  if (!user) {
    return <div>Please log in to manage your settings.</div>
  }
        ...
        >
          <div className="notification-settings__fields">
            ...
            <CustomFormField
              ...
              type="select"
              options={[
                { value: 'immidiate', label: 'Immidiate' },
...
export default SharedNotiificationSettings
